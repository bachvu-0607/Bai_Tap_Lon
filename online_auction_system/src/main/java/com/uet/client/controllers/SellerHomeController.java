...
/**
 * Bộ điều khiển (Controller) trang chủ dành cho Người bán (Seller Home).
 * Quản lý thanh điều hướng, khu vực hiển thị nội dung động (tải các view con như Home, AuctionList, MyProduct),
 * hiển thị số lượng người dùng online thời gian thực và xử lý đăng xuất.
 */
public class SellerHomeController {
    ...
    /**
     * Khởi tạo giao diện Seller Home.
     * Đăng ký sự kiện lắng nghe số lượng người dùng online toàn cục từ Server,
     * thiết lập chiều cao động cho trang giới thiệu và nạp màn hình trang chủ con.
     */
    @FXML
