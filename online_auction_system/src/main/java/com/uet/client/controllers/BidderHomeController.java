...
/**
 * Bộ điều khiển (Controller) trang chủ dành cho Người đấu giá (Bidder Home).
 * Quản lý các nút liên kết như Trang chủ, Danh sách đấu giá, Đơn hàng, Ví tiền,
 * cập nhật số lượng người trực tuyến thời gian thực và quản lý đăng xuất.
 */
public class BidderHomeController {
    ...
    /**
     * Khởi tạo giao diện Bidder Home.
     * Kiểm tra phiên làm việc của người dùng để hiển thị lời chào,
     * thiết lập bộ lắng nghe số lượng người dùng online thời gian thực và nạp view trang chủ con.
     */
    @FXML
