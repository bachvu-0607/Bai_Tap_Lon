...
/**
 * Bộ điều khiển (Controller) quản lý màn hình danh sách phiên đấu giá (Auction List).
 * Cung cấp giao diện hiển thị các phiên đấu giá dưới dạng bảng,
 * hỗ trợ các tính năng đặt giá (Bid), xem lịch sử đặt giá chi tiết qua một Panel trượt (Drawer Panel),
 * hiển thị biểu đồ diễn biến giá của sản phẩm và cập nhật dữ liệu tự động thời gian thực.
 */
public class AuctionListController {
    ...
    /**
     * Khởi tạo giao diện danh sách đấu giá.
     * Cấu hình liên kết các cột của bảng, khởi tạo biểu đồ, giấu Drawer Panel,
     * thiết lập listener chọn dòng và bộ lắng nghe sự kiện cập nhật realtime từ Server.
     */
    @FXML
