...
/**
 * Bộ điều khiển (Controller) quản lý màn hình đăng sản phẩm đấu giá mới (Post Product).
 * Dành cho người bán (Seller) điền các thông tin của sản phẩm (tên, mô tả, danh mục, giá mở cửa, bước giá tối thiểu,
 * thời gian bắt đầu, kết thúc, link ảnh) và gửi yêu cầu đăng lên hệ thống.
 */
public class PostProductController {
    ...
    /**
     * Khởi tạo giao diện đăng sản phẩm.
     * Cấu hình danh mục sản phẩm (Electronics, Art, Vehicle) và chuẩn bị các ô nhập mốc thời gian.
     */
    @FXML
