...
/**
 * Bộ điều khiển (Controller) quản lý danh sách sản phẩm của chính tôi (MyProduct).
 * Dành cho người bán (Seller) để theo dõi các sản phẩm mình đã đăng bán,
 * xem trạng thái (chờ duyệt, đang chạy, đã bán, bị từ chối) và dẫn tới màn hình đăng sản phẩm mới.
 */
public class MyProductController {
    ...
    /**
     * Khởi tạo giao diện MyProduct.
     * Liên kết các cột TableView với các thuộc tính tóm tắt sản phẩm {@link AuctionSummary},
     * nạp danh sách sản phẩm đã đăng và đăng ký bộ lắng nghe sự kiện realtime từ Server.
     */
    @FXML
